...
- [ ] **T1 — Crate skeleton, SDK registration** (R4)
...
- [ ] **T2 — Embedders and chunker** (R15, R21)
...
- [ ] **T3 — Store: tables, schema, move-aside, separation** (R1, R2, R3, R5, R7, R12, R13)
...
- [ ] **T4 — Bounded writes and "busy"** (R8, R10, R11)
  - Files: `cobolt-kb/src/store.rs`.
...
- [ ] **T5 — Refresh, add/update/delete, converter seam** (R14, R16–R20, R26a)
...
- [ ] **T8 — Built-in semantic embedder** (R22, R23, R23a)
...
- [ ] **T9 — Runtime features and HTTP transport** (R4, R24)
...
- [ ] **T10 — Forms model: `ControlType::KnowledgeBase`** (R27)
...
- [ ] **T11 — Interpreter: methods, async outcomes, event payloads** (R16, R17, R28–R31)
...
- [ ] **T13 — Seeding for all hosts** (R5, R7, R34)
...
- [ ] **T14 — `[rag] embedder`, RuntimeFeatures, delivery** (R4, R22)
...
- [ ] **T16 — System KB and Developer's Guide**
