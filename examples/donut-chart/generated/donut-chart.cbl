      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ShowLabels" "0"
           DISPLAY SUBJ::GetProperty("ShowLabels").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "LabelFormat" "TEST"
           DISPLAY SUBJ::GetProperty("LabelFormat").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "InnerRadius" "50"
           DISPLAY SUBJ::GetProperty("InnerRadius").
