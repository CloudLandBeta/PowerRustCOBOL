# DonutChart — control test example

Subject control: **DonutChart**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/donut-chart/cobolt.toml
```
...
> `generated/donut-chart.cbl` is codegen output (regenerable from the form);
