# AgentObject — control test example

Subject control: **AgentObject**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/agent-object/cobolt.toml
```
...
> `generated/agent-object.cbl` is codegen output (regenerable from the form);
