      ...
      *>── Form controls ───────────────────────────────────────────────
       ...
       01 WS-B38.
          05 WS-B38-TEXT       PIC X(256) VALUE 'StreamChunkParagraph'.
          05 WS-B38-VISIBLE    PIC 9      VALUE 1.
          05 WS-B38-ENABLED    PIC 9      VALUE 1.

       01 WS-B39.
          05 WS-B39-TEXT       PIC X(256) VALUE 'ResponseDataItem'.
               ...
               EVALUATE COBOL-CONTROL-ID
                   WHEN "SUBJ"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onResponse"
                               CALL "SUBJ--ONRESPONSE"
                           WHEN "onError"
                               CALL "SUBJ--ONERROR"
                           WHEN "onStreamChunk"
                               CALL "SUBJ--ONSTREAMCHUNK"
                           WHEN "onThinking"
                               CALL "SUBJ--ONTHINKING"
                       END-EVALUATE
                   WHEN "B00"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onClick"
       ...
       SUBJ-ASK.
      *>    Ask the AI agent SUBJ (model: llama3.2, endpoint: x)
      *>    Set WS-AGENT-PROMPT before calling.
           INVOKE SUBJ 'Ask'
               USING BY VALUE WS-AGENT-PROMPT
               RETURNING WS-AGENT-RESPONSE
           EVALUATE TRUE
               WHEN WS-AGENT-ERROR = SPACES
                   PERFORM 
               WHEN OTHER
                   PERFORM 
           END-EVALUATE.
       ...
       .
      *>    TODO: SUBJ response ready — WS-AGENT-RESPONSE contains the LLM reply
           CONTINUE.

       .
      *>    TODO: SUBJ error handler — WS-AGENT-ERROR contains the error message
           CONTINUE.
      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           DISPLAY "onResponse working".

           GOBACK.

       END PROGRAM SUBJ--ONRESPONSE.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onStreamChunk working".

           GOBACK.

       END PROGRAM SUBJ--ONSTREAMCHUNK.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONTHINKING.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onThinking working".

           GOBACK.

       END PROGRAM SUBJ--ONTHINKING.
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AgentURL" "TEST"
           DISPLAY SUBJ::GetProperty("AgentURL").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AgentModel" "TEST"
           DISPLAY SUBJ::GetProperty("AgentModel").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AgentAPI" "TEST"
           DISPLAY SUBJ::GetProperty("AgentAPI").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AgentAPIKey" "TEST"
           DISPLAY SUBJ::GetProperty("AgentAPIKey").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AgentEndpoint" "TEST"
           DISPLAY SUBJ::GetProperty("AgentEndpoint").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "SystemPrompt" "TEST"
           DISPLAY SUBJ::GetProperty("SystemPrompt").
       ...
       PROCEDURE DIVISION.
           ...
           DISPLAY SUBJ::GetProperty("Temperature").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "MaximumTokens" "1034"
           DISPLAY SUBJ::GetProperty("MaximumTokens").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Stream" "0"
           DISPLAY SUBJ::GetProperty("Stream").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "TargetControls" "TEST"
           DISPLAY SUBJ::GetProperty("TargetControls").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "StreamChunkParagraph" "TEST"
           DISPLAY SUBJ::GetProperty("StreamChunkParagraph").
