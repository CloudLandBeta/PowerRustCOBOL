      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "LineDirection" "TEST"
           DISPLAY SUBJ::GetProperty("LineDirection").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "DashStyle" "TEST"
           DISPLAY SUBJ::GetProperty("DashStyle").
