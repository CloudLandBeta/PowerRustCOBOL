# Line — control test example

Subject control: **Line**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/line/cobolt.toml
```
...
> `generated/line.cbl` is codegen output (regenerable from the form);
