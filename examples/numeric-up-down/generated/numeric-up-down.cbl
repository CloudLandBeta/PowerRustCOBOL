      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "DecimalPlaces" "10"
           DISPLAY SUBJ::GetProperty("DecimalPlaces").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ThousandsSeparator" "1"
           DISPLAY SUBJ::GetProperty("ThousandsSeparator").
