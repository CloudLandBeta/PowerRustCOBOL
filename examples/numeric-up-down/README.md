# NumericUpDown — control test example

Subject control: **NumericUpDown**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/numeric-up-down/cobolt.toml
```
...
> `generated/numeric-up-down.cbl` is codegen output (regenerable from the form);
