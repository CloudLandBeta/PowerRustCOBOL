# Label — control test example

Subject control: **Label**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/label/cobolt.toml
```
...
> `generated/label.cbl` is codegen output (regenerable from the form);
