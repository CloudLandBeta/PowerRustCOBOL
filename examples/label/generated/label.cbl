      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "WordWrap" "1"
           DISPLAY SUBJ::GetProperty("WordWrap").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AutoSize" "1"
           DISPLAY SUBJ::GetProperty("AutoSize").
