      ...
      *>── Timer: SUBJ ──────────────────────────────────────────
       01 WS-SUBJ-INTERVAL   PIC 9(8) VALUE 1000.
       01 WS-SUBJ-ENABLED    PIC 9    VALUE 1.
       01 WS-SUBJ-ELAPSED-MS PIC 9(8) VALUE 0.
      ...
      *>    Called once from COBOL-MAIN to register timer intervals.
           INVOKE SUBJ 'SetInterval' USING BY VALUE 1000
           CONTINUE.
      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           DISPLAY "onTick working".

           GOBACK.

       END PROGRAM SUBJ--ONTICK.
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Interval" "1010"
           DISPLAY SUBJ::GetProperty("Interval").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Enabled" "0"
           DISPLAY SUBJ::GetProperty("Enabled").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Paragraph" "TEST"
           DISPLAY SUBJ::GetProperty("Paragraph").
