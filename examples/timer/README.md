# Timer — control test example

Subject control: **Timer**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/timer/cobolt.toml
```
...
> `generated/timer.cbl` is codegen output (regenerable from the form);
