# PictureBox — control test example

Subject control: **PictureBox**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/picture-box/cobolt.toml
```
...
> `generated/picture-box.cbl` is codegen output (regenerable from the form);
