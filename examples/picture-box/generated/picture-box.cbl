      ...
      *>── Form controls ───────────────────────────────────────────────
       ...
       01 WS-B30.
          05 WS-B30-TEXT       PIC X(256) VALUE 'ShowFrame'.
      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "SizeMode" "TEST"
           DISPLAY SUBJ::GetProperty("SizeMode").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ShowFrame" "0"
           DISPLAY SUBJ::GetProperty("ShowFrame").
