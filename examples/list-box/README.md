# ListBox — control test example

Subject control: **ListBox**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/list-box/cobolt.toml
```
...
> `generated/list-box.cbl` is codegen output (regenerable from the form);
