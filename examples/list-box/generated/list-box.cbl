      ...
      *>── Form controls ───────────────────────────────────────────────
       ...
       01 WS-B27.
          05 WS-B27-TEXT       PIC X(256) VALUE 'MultiSelect'.
          05 WS-B27-VISIBLE    PIC 9      VALUE 1.
          05 WS-B27-ENABLED    PIC 9      VALUE 1.

       01 WS-B28.
          05 WS-B28-TEXT       PIC X(256) VALUE 'Sorted'.
       ...
       01 WS-B30.
          05 WS-B30-TEXT       PIC X(256) VALUE 'BorderColor'.
      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "MultiSelect" "1"
           DISPLAY SUBJ::GetProperty("MultiSelect").
