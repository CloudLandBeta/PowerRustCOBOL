# Shape — control test example

Subject control: **Shape**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/shape/cobolt.toml
```
...
> `generated/shape.cbl` is codegen output (regenerable from the form);
