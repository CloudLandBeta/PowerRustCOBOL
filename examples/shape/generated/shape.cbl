      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ShapeType" "TEST"
           DISPLAY SUBJ::GetProperty("ShapeType").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "FillStyle" "TEST"
           DISPLAY SUBJ::GetProperty("FillStyle").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "LineThickness" "11"
           DISPLAY SUBJ::GetProperty("LineThickness").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "LineStyle" "TEST"
           DISPLAY SUBJ::GetProperty("LineStyle").
