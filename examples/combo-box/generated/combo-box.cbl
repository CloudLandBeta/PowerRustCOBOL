                   ...
                   WHEN "SUBJ"
                       EVALUATE COBOL-EVENT-ID
                           ...
                           WHEN "onSelectedIndexChanged"
                               CALL "SUBJ--ONSELECTEDINDEXCHANGED"
                           WHEN "onDropDown"
                               CALL "SUBJ--ONDROPDOWN"
                       END-EVALUATE
                   WHEN "B00"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onClick"
      ...
      *>    TODO: Form onClose handler
       ...
       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONSELECTEDINDEXCHANGED.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onSelectedIndexChanged working".

           GOBACK.

       END PROGRAM SUBJ--ONSELECTEDINDEXCHANGED.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONDROPDOWN.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onDropDown working".

           GOBACK.

       END PROGRAM SUBJ--ONDROPDOWN.
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "SelectedIndex" "9"
           DISPLAY SUBJ::GetProperty("SelectedIndex").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "DropDownStyle" "TEST"
           DISPLAY SUBJ::GetProperty("DropDownStyle").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "DropDownHeight" "210"
           DISPLAY SUBJ::GetProperty("DropDownHeight").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Editable" "0"
           DISPLAY SUBJ::GetProperty("Editable").
