# ComboBox — control test example

Subject control: **ComboBox**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/combo-box/cobolt.toml
```
...
> `generated/combo-box.cbl` is codegen output (regenerable from the form);
