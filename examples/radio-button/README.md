# RadioButton — control test example

Subject control: **RadioButton**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/radio-button/cobolt.toml
```
...
> `generated/radio-button.cbl` is codegen output (regenerable from the form);
