# GroupBox — control test example

Subject control: **GroupBox**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/group-box/cobolt.toml
```
...
> `generated/group-box.cbl` is codegen output (regenerable from the form);
