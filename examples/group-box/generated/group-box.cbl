      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Scrollable" "1"
           DISPLAY SUBJ::GetProperty("Scrollable").
