      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "TabPosition" "TEST"
           DISPLAY SUBJ::GetProperty("TabPosition").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "SelectedTab" "10"
           DISPLAY SUBJ::GetProperty("SelectedTab").
