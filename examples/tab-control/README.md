# TabControl — control test example

Subject control: **TabControl**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/tab-control/cobolt.toml
```
...
> `generated/tab-control.cbl` is codegen output (regenerable from the form);
