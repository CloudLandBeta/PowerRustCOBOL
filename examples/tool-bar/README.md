# ToolBar — control test example

Subject control: **ToolBar**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/tool-bar/cobolt.toml
```
...
> `generated/tool-bar.cbl` is codegen output (regenerable from the form);
