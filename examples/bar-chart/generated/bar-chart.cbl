      ...
      *>── Form controls ───────────────────────────────────────────────
       ...
       01 WS-B40.
          05 WS-B40-TEXT       PIC X(256) VALUE 'Horizontal'.
          05 WS-B40-VISIBLE    PIC 9      VALUE 1.
          05 WS-B40-ENABLED    PIC 9      VALUE 1.

       01 WS-B41.
          05 WS-B41-TEXT       PIC X(256) VALUE 'Stacked'.
          05 WS-B41-VISIBLE    PIC 9      VALUE 1.
          05 WS-B41-ENABLED    PIC 9      VALUE 1.

       01 WS-B42.
          05 WS-B42-TEXT       PIC X(256) VALUE 'BarCornerRadius'.
      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Horizontal" "1"
           DISPLAY SUBJ::GetProperty("Horizontal").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "BarCornerRadius" "13"
           DISPLAY SUBJ::GetProperty("BarCornerRadius").
