# BarChart — control test example

Subject control: **BarChart**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/bar-chart/cobolt.toml
```
...
> `generated/bar-chart.cbl` is codegen output (regenerable from the form);
