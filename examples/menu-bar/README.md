# MenuBar — control test example

Subject control: **MenuBar**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/menu-bar/cobolt.toml
```
...
> `generated/menu-bar.cbl` is codegen output (regenerable from the form);
