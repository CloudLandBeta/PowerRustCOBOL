      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           DISPLAY "onStarted working".

           GOBACK.

       END PROGRAM SUBJ--ONSTARTED.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONENDED.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onEnded working".

           GOBACK.

       END PROGRAM SUBJ--ONENDED.
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Source" "TEST"
           DISPLAY SUBJ::GetProperty("Source").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AutoPlay" "0"
           DISPLAY SUBJ::GetProperty("AutoPlay").
