# Animator — control test example

Subject control: **Animator**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/animator/cobolt.toml
```
...
> `generated/animator.cbl` is codegen output (regenerable from the form);
