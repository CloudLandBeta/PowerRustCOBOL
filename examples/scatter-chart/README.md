# ScatterChart — control test example

Subject control: **ScatterChart**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/scatter-chart/cobolt.toml
```
...
> `generated/scatter-chart.cbl` is codegen output (regenerable from the form);
