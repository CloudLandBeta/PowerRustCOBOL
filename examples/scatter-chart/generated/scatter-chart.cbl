      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "BubbleField" "TEST"
           DISPLAY SUBJ::GetProperty("BubbleField").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "BubbleScale" "30"
           DISPLAY SUBJ::GetProperty("BubbleScale").
