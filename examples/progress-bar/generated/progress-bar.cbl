      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "BarColor" "#CC3300"
           DISPLAY SUBJ::GetProperty("BarColor").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Style" "TEST"
           DISPLAY SUBJ::GetProperty("Style").
