# ProgressBar — control test example

Subject control: **ProgressBar**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/progress-bar/cobolt.toml
```
...
> `generated/progress-bar.cbl` is codegen output (regenerable from the form);
