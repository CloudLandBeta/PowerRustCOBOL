# RestClient — control test example

Subject control: **RestClient**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/rest-client/cobolt.toml
```
...
> `generated/rest-client.cbl` is codegen output (regenerable from the form);
