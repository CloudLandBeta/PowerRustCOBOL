# Slider — control test example

Subject control: **Slider**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/slider/cobolt.toml
```
...
> `generated/slider.cbl` is codegen output (regenerable from the form);
