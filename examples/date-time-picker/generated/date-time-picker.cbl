      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Format" "TEST"
           DISPLAY SUBJ::GetProperty("Format").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "CustomFormat" "TEST"
           DISPLAY SUBJ::GetProperty("CustomFormat").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ShowUpDown" "1"
           DISPLAY SUBJ::GetProperty("ShowUpDown").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "MinimumDate" "TEST"
           DISPLAY SUBJ::GetProperty("MinimumDate").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "MaximumDate" "TEST"
           DISPLAY SUBJ::GetProperty("MaximumDate").
