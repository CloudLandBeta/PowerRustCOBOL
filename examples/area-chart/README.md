# AreaChart — control test example

Subject control: **AreaChart**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/area-chart/cobolt.toml
```
...
> `generated/area-chart.cbl` is codegen output (regenerable from the form);
