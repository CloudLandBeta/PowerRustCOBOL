# Panel — control test example

Subject control: **Panel**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/panel/cobolt.toml
```
...
> `generated/panel.cbl` is codegen output (regenerable from the form);
