# TreeView — control test example

Subject control: **TreeView**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/tree-view/cobolt.toml
```
...
> `generated/tree-view.cbl` is codegen output (regenerable from the form);
