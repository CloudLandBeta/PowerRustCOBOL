               ...
               EVALUATE COBOL-CONTROL-ID
                   WHEN "SUBJ"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onNodeClick"
                               CALL "SUBJ--ONNODECLICK"
                           WHEN "onNodeDblClick"
                               CALL "SUBJ--ONNODEDBLCLICK"
                           WHEN "onNodeExpand"
                               CALL "SUBJ--ONNODEEXPAND"
                           WHEN "onNodeCollapse"
                               CALL "SUBJ--ONNODECOLLAPSE"
                           WHEN "onNodeChecked"
                               CALL "SUBJ--ONNODECHECKED"
                       END-EVALUATE
                   WHEN "B00"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onClick"
      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           DISPLAY "onNodeClick working".

           GOBACK.

       END PROGRAM SUBJ--ONNODECLICK.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONNODEDBLCLICK.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onNodeDblClick working".

           GOBACK.

       END PROGRAM SUBJ--ONNODEDBLCLICK.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONNODEEXPAND.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onNodeExpand working".

           GOBACK.

       END PROGRAM SUBJ--ONNODEEXPAND.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONNODECOLLAPSE.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onNodeCollapse working".

           GOBACK.

       END PROGRAM SUBJ--ONNODECOLLAPSE.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONNODECHECKED.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onNodeChecked working".

           GOBACK.

       END PROGRAM SUBJ--ONNODECHECKED.
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Items" "TEST"
           DISPLAY SUBJ::GetProperty("Items").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AllowEdit" "1"
           DISPLAY SUBJ::GetProperty("AllowEdit").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "CheckBoxes" "1"
           DISPLAY SUBJ::GetProperty("CheckBoxes").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ShowLines" "0"
           DISPLAY SUBJ::GetProperty("ShowLines").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ShowRootLines" "0"
           DISPLAY SUBJ::GetProperty("ShowRootLines").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Sorted" "1"
           DISPLAY SUBJ::GetProperty("Sorted").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "HotTracking" "1"
           DISPLAY SUBJ::GetProperty("HotTracking").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "LineColor" "#CC3300"
           DISPLAY SUBJ::GetProperty("LineColor").
