# SqlDatabase — control test example

Subject control: **SqlDatabase**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/sql-database/cobolt.toml
```
...
> `generated/sql-database.cbl` is codegen output (regenerable from the form);
