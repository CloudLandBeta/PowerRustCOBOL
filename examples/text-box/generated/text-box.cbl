      ...
      *>── Form controls ───────────────────────────────────────────────
       01 WS-SUBJ.
          05 WS-SUBJ-TEXT       PIC X(256) VALUE ''.
                   ...
                   WHEN "SUBJ"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onChange"
                               CALL "SUBJ--ONCHANGE"
                           WHEN "onKeyPress"
                               CALL "SUBJ--ONKEYPRESS"
                           WHEN "onKeyDown"
                               CALL "SUBJ--ONKEYDOWN"
                           WHEN "onKeyUp"
                               CALL "SUBJ--ONKEYUP"
                           WHEN "onGotFocus"
                               CALL "SUBJ--ONGOTFOCUS"
                           WHEN "onLostFocus"
                               CALL "SUBJ--ONLOSTFOCUS"
                           WHEN "onEnter"
                               CALL "SUBJ--ONENTER"
                           WHEN "onLeave"
                               CALL "SUBJ--ONLEAVE"
      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           DISPLAY "onChange working".

           GOBACK.

       END PROGRAM SUBJ--ONCHANGE.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONKEYPRESS.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onKeyPress working".

           GOBACK.

       END PROGRAM SUBJ--ONKEYPRESS.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONKEYDOWN.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onKeyDown working".

           GOBACK.

       END PROGRAM SUBJ--ONKEYDOWN.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONKEYUP.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onKeyUp working".

           GOBACK.

       END PROGRAM SUBJ--ONKEYUP.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONGOTFOCUS.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onGotFocus working".

           GOBACK.

       END PROGRAM SUBJ--ONGOTFOCUS.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONLOSTFOCUS.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onLostFocus working".

           GOBACK.

       END PROGRAM SUBJ--ONLOSTFOCUS.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONENTER.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onEnter working".

           GOBACK.

       END PROGRAM SUBJ--ONENTER.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONLEAVE.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onLeave working".

           GOBACK.

       END PROGRAM SUBJ--ONLEAVE.
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "HintText" "TEST"
           DISPLAY SUBJ::GetProperty("HintText").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "MaximumLength" "10"
           DISPLAY SUBJ::GetProperty("MaximumLength").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Multiline" "1"
           DISPLAY SUBJ::GetProperty("Multiline").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "PasswordCharacter" "TEST"
           DISPLAY SUBJ::GetProperty("PasswordCharacter").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ScrollBars" "TEST"
           DISPLAY SUBJ::GetProperty("ScrollBars").
