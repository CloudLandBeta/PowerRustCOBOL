      ...
      *>── DataGrid SUBJ CSV export ──────────────────────────
       01 WS-SUBJ-CSV-PATH    PIC X(512)  VALUE SPACES.
       01 WS-SUBJ-CSV-STATUS  PIC 9       VALUE 0.
      ...
      *>── Form controls ───────────────────────────────────────────────
               ...
               EVALUATE COBOL-CONTROL-ID
                   WHEN "SUBJ"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onCellClick"
                               CALL "SUBJ--ONCELLCLICK"
                           WHEN "onCellChange"
                               CALL "SUBJ--ONCELLCHANGE"
                           WHEN "onRowSelect"
                               CALL "SUBJ--ONROWSELECT"
                           WHEN "onColumnClick"
                               CALL "SUBJ--ONCOLUMNCLICK"
                           WHEN "onExportCSV"
                               CALL "SUBJ--ONEXPORTCSV"
                       END-EVALUATE
                   WHEN "B00"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onClick"
       ...
       .
      *>    Export SUBJ data to CSV file.  Delimiter: ","
      *>    Set WS-SUBJ-CSV-PATH to the desired output file path before calling.
           INVOKE SUBJ 'ExportCSV'
               USING BY REFERENCE WS-SUBJ-CSV-PATH
               RETURNING WS-SUBJ-CSV-STATUS
           IF WS-SUBJ-CSV-STATUS NOT = 0
               DISPLAY "CSV export error: " WS-SUBJ-CSV-STATUS
           END-IF.
      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           DISPLAY "onCellClick working".

           GOBACK.

       END PROGRAM SUBJ--ONCELLCLICK.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONCELLCHANGE.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onCellChange working".

           GOBACK.

       END PROGRAM SUBJ--ONCELLCHANGE.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONROWSELECT.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onRowSelect working".

           GOBACK.

       END PROGRAM SUBJ--ONROWSELECT.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONCOLUMNCLICK.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onColumnClick working".

           GOBACK.

       END PROGRAM SUBJ--ONCOLUMNCLICK.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONEXPORTCSV.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onExportCSV working".

           GOBACK.

       END PROGRAM SUBJ--ONEXPORTCSV.
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Columns" "TEST"
           DISPLAY SUBJ::GetProperty("Columns").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ReadOnly" "1"
           DISPLAY SUBJ::GetProperty("ReadOnly").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AlternatingRowColor" "#CC3300"
           DISPLAY SUBJ::GetProperty("AlternatingRowColor").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "HeaderBackgroundColor" "#0066CC"
           DISPLAY SUBJ::GetProperty("HeaderBackgroundColor").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "HeaderForegroundColor" "#CC3300"
           DISPLAY SUBJ::GetProperty("HeaderForegroundColor").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "GridLineColor" "#CC3300"
           DISPLAY SUBJ::GetProperty("GridLineColor").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "SelectionMode" "TEST"
           DISPLAY SUBJ::GetProperty("SelectionMode").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "RowHeight" "32"
           DISPLAY SUBJ::GetProperty("RowHeight").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AllowSorting" "0"
           DISPLAY SUBJ::GetProperty("AllowSorting").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "AllowColumnResize" "0"
           DISPLAY SUBJ::GetProperty("AllowColumnResize").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ShowRowNumbers" "1"
           DISPLAY SUBJ::GetProperty("ShowRowNumbers").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ExportCSV" "0"
           DISPLAY SUBJ::GetProperty("ExportCSV").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "CSVDelimiter" "TEST"
           DISPLAY SUBJ::GetProperty("CSVDelimiter").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "CSVParagraph" "TEST"
           DISPLAY SUBJ::GetProperty("CSVParagraph").
