# DataGrid — control test example

Subject control: **DataGrid**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/data-grid/cobolt.toml
```
...
> `generated/data-grid.cbl` is codegen output (regenerable from the form);
