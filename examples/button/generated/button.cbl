                   ...
                   WHEN "SUBJ"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onClick"
                               CALL "SUBJ--ONCLICK"
                           WHEN "onDblClick"
                               CALL "SUBJ--ONDBLCLICK"
                           WHEN "onMouseEnter"
                               CALL "SUBJ--ONMOUSEENTER"
                           WHEN "onMouseLeave"
                               CALL "SUBJ--ONMOUSELEAVE"
                           WHEN "onMouseDown"
                               CALL "SUBJ--ONMOUSEDOWN"
                           WHEN "onMouseUp"
                               CALL "SUBJ--ONMOUSEUP"
                       END-EVALUATE
                   WHEN "B00"
      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           DISPLAY "onDblClick working".

           GOBACK.

       END PROGRAM SUBJ--ONDBLCLICK.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONMOUSEENTER.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onMouseEnter working".

           GOBACK.

       END PROGRAM SUBJ--ONMOUSEENTER.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONMOUSELEAVE.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onMouseLeave working".

           GOBACK.

       END PROGRAM SUBJ--ONMOUSELEAVE.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONMOUSEDOWN.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onMouseDown working".

           GOBACK.

       END PROGRAM SUBJ--ONMOUSEDOWN.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONMOUSEUP.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onMouseUp working".

           GOBACK.

       END PROGRAM SUBJ--ONMOUSEUP.
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Caption" "TEST"
           DISPLAY SUBJ::GetProperty("Caption").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "IsDefault" "1"
           DISPLAY SUBJ::GetProperty("IsDefault").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "IsCancel" "1"
           DISPLAY SUBJ::GetProperty("IsCancel").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ModalResult" "TEST"
           DISPLAY SUBJ::GetProperty("ModalResult").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "BorderColor" "#CC3300"
           DISPLAY SUBJ::GetProperty("BorderColor").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "BorderStyle" "TEST"
           DISPLAY SUBJ::GetProperty("BorderStyle").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "CornerRadius" "13"
           DISPLAY SUBJ::GetProperty("CornerRadius").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "FlatStyle" "1"
           DISPLAY SUBJ::GetProperty("FlatStyle").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ImagePath" "TEST"
           DISPLAY SUBJ::GetProperty("ImagePath").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "ImageAlignment" "TEST"
           DISPLAY SUBJ::GetProperty("ImageAlignment").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "TextAlignment" "TEST"
           DISPLAY SUBJ::GetProperty("TextAlignment").
