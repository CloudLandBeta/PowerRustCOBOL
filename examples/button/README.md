# Button — control test example

Subject control: **Button**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/button/cobolt.toml
```
...
> `generated/button.cbl` is codegen output (regenerable from the form);
