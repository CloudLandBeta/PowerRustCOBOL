# Splitter — control test example

Subject control: **Splitter**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/splitter/cobolt.toml
```
...
> `generated/splitter.cbl` is codegen output (regenerable from the form);
