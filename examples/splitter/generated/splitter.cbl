      ...
      *>    TODO: Form onClose handler
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "MinimumSize" "35"
           DISPLAY SUBJ::GetProperty("MinimumSize").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "SplitPosition" "110"
           DISPLAY SUBJ::GetProperty("SplitPosition").
