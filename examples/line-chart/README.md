# LineChart — control test example

Subject control: **LineChart**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/line-chart/cobolt.toml
```
...
> `generated/line-chart.cbl` is codegen output (regenerable from the form);
