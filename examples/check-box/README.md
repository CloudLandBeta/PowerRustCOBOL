# CheckBox — control test example

Subject control: **CheckBox**. The form fires a console `DISPLAY "<Event> working"`
...
```sh
rcrun build examples/check-box/cobolt.toml
```
...
> `generated/check-box.cbl` is codegen output (regenerable from the form);
