      ...
      *>── Form controls ───────────────────────────────────────────────
       01 WS-SUBJ.
          ...
          05 WS-SUBJ-VALUE      PIC X(512) VALUE SPACES.
      ...
      *>    TODO: Form onClose handler
       ...
       IDENTIFICATION DIVISION.
       PROGRAM-ID. SUBJ--ONCHECKEDCHANGED.
       ...
       PROCEDURE DIVISION.
           DISPLAY "onCheckedChanged working".

           GOBACK.

       END PROGRAM SUBJ--ONCHECKEDCHANGED.
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "Checked" "1"
           DISPLAY SUBJ::GetProperty("Checked").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "GroupName" "TEST"
           DISPLAY SUBJ::GetProperty("GroupName").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "CheckAlignment" "TEST"
           DISPLAY SUBJ::GetProperty("CheckAlignment").
       ...
       PROCEDURE DIVISION.
           INVOKE SUBJ "SetProperty"
               USING "CheckColor" "#CC3300"
           DISPLAY SUBJ::GetProperty("CheckColor").
