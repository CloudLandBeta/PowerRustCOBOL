      ...
      *>── Cobolt runtime fields ─────────────────────────────────────
       ...
       01 FORM-NAME               PIC X(64)   VALUE 'TOOLBAR-FORM'.

      *>── Form controls ───────────────────────────────────────────────
       01 WS-TB-MAIN.
          05 WS-TB-MAIN-TEXT       PIC X(256) VALUE 'TB-MAIN'.
          05 WS-TB-MAIN-VISIBLE    PIC 9      VALUE 1.
          05 WS-TB-MAIN-ENABLED    PIC 9      VALUE 1.
               ...
               EVALUATE COBOL-CONTROL-ID
                   WHEN "TB-MAIN-FILE-SAVE"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onClick"
                               CALL "TB-MAIN-FILE-SAVE--ONCLICK"
                       END-EVALUATE
                   WHEN "TB-MAIN-FILE-OPEN"
                       EVALUATE COBOL-EVENT-ID
                           WHEN "onClick"
                               CALL "RECALC"
                       END-EVALUATE
      ...
      *> ── Nested event-handler programs (COBOL-85) ─────────────────────
       ...
       IDENTIFICATION DIVISION.
       PROGRAM-ID. TOOLBAR-FORM--ONLOAD IS COMMON PROGRAM.
      ...
      *>    TODO: Form onLoad handler
       ...
       END PROGRAM TOOLBAR-FORM--ONLOAD.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. TOOLBAR-FORM--ONCLOSE IS COMMON PROGRAM.
      ...
      *>    TODO: Form onClose handler
       ...
       END PROGRAM TOOLBAR-FORM--ONCLOSE.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. TB-MAIN-FILE-SAVE--ONCLICK IS COMMON PROGRAM.
       ...
       END PROGRAM TB-MAIN-FILE-SAVE--ONCLICK.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. RECALC IS COMMON PROGRAM.
