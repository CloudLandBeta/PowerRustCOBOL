      ...
      *>── Cobolt runtime fields ─────────────────────────────────────
       ...
       01 FORM-NAME               PIC X(64)   VALUE 'EMPTY-FORM'.

       PROCEDURE DIVISION.
       COBOL-MAIN.
           CALL "COBOL-INIT-FORM" USING FORM-NAME
           CALL "EMPTY-FORM--ONLOAD"
      ...
      *> ── Nested event-handler programs (COBOL-85) ─────────────────────
       ...
       IDENTIFICATION DIVISION.
       PROGRAM-ID. EMPTY-FORM--ONLOAD IS COMMON PROGRAM.
      ...
      *>    TODO: Form onLoad handler
       ...
       END PROGRAM EMPTY-FORM--ONLOAD.

       IDENTIFICATION DIVISION.
       PROGRAM-ID. EMPTY-FORM--ONCLOSE IS COMMON PROGRAM.
      ...
      *>    TODO: Form onClose handler
       ...
       END PROGRAM EMPTY-FORM--ONCLOSE.

       END PROGRAM EMPTY-FORM.
