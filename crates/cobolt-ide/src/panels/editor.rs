...
fn properties_for_type(ctrl_type: &str) -> &'static [(&'static str, &'static str)] {
    match ctrl_type {
        "Button" => &[
            ...
            ("BackColor",    "Background colour (RRGGBB)"),
            ("ForeColor",    "Text colour (RRGGBB)"),
        ...
        "TextBox" => &[
            ...
            ("PasswordChar", "Masking character (e.g. *)"),
            ("BackColor",    "Background colour (RRGGBB)"),
            ("ForeColor",    "Text colour (RRGGBB)"),
            ("FontSize",     "Font size in points"),
        ...
        _ => &[
            ...
            ("Height",   "Height in pixels"),
            ("BackColor","Background colour (RRGGBB)"),
            ("ForeColor","Foreground colour (RRGGBB)"),
            ("Opacity",  "Opacity 0–100"),
        ],
    }
}
