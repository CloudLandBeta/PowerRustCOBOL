...
/// One IDE colour theme. Panel/control fills carry their own alpha so the
...
pub struct Theme {
    ...
    pub bg_control: Color32, // inactive control fill
...
pub const DEEP_BLUE: Theme = Theme {
    ...
    name: "Deep Blue",
    dark: true,
    // Near-black glass panes (blue accents/borders/text are kept below).
    bg_panel: rgba(8, 9, 12, 212),
    bg_control: rgba(16, 18, 22, 206),
    bg_hover: rgba(28, 31, 38, 218),
    bg_active: rgba(40, 92, 165, 232),
    bg_extreme: rgba(5, 6, 8, 216),
    faint_bg: rgba(10, 11, 14, 150),
    code_bg: rgba(7, 8, 10, 196),
...
pub const LIGHT_PLUS: Theme = Theme {
    ...
    bg_control: rgba(255, 255, 255, 245),
...
pub const SOLARIZED_LIGHT: Theme = Theme {
    ...
    bg_control: rgba(238, 232, 213, 246),
...
pub const GITHUB_LIGHT: Theme = Theme {
    ...
    bg_control: rgba(255, 255, 255, 246),
...
pub const ONE_LIGHT: Theme = Theme {
    ...
    bg_control: rgba(250, 250, 250, 246),
...
pub const GRUVBOX_LIGHT: Theme = Theme {
    ...
    bg_control: rgba(242, 229, 188, 246),
...
pub const AYU_LIGHT: Theme = Theme {
    ...
    bg_control: rgba(252, 252, 252, 246),
...
pub const NORD_LIGHT: Theme = Theme {
    ...
    bg_control: rgba(229, 233, 240, 246),
...
pub const ROSE_PINE_DAWN: Theme = Theme {
    ...
    bg_control: rgba(255, 250, 243, 246),
...
pub const CATPPUCCIN_LATTE: Theme = Theme {
    ...
    bg_control: rgba(230, 233, 239, 246),
...
pub const CLASSIC: Theme = Theme {
    ...
    bg_control: rgba(212, 208, 200, 252),
...
mod tests {
    ...
    fn line_is_light_grey_on_dark_themes() {
        ...
        assert!(
            dark_line.r() > 130 && dark_line.g() > 130 && dark_line.b() > 130,
