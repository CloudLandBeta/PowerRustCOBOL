...
pub fn property_reference(name: &str) -> Option<(&'static str, &'static str)> {
    Some(match name {
        ...
        "CheckSpacing" => ("points 0-64 (default 6)", "CheckBox / RadioButton: the distance between the box (or circle) and the caption, on whichever side `CheckAlignment` puts the box."),
