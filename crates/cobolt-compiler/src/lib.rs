...
pub fn control_method_docs(name: &str) -> Vec<(&'static str, &'static str)> {
    ...
    match name {
        ...
        "SideMenu" => vec![
            ...
            ("SetItemLabel(id: String, label: String) → 1/0", "Rename a row the program added. `0` for a designed row."),
            ...
            ("SetItemEnabled(id: String, enabled: Boolean) → 1/0", "Grey a run-time row out, or back."),
