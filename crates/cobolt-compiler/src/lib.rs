...
pub fn property_reference(name: &str) -> Option<(&'static str, &'static str)> {
    Some(match name {
        ...
        "Stream" => ("retired", "**Retired.** Replies were never streamed: every request asks for the whole reply. No longer seeded or shown; a value in an older form, or a COBOL read or write of it, is kept and ignored."),
