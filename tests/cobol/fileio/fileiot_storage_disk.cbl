      ...
      *>   - Storage variant: 1. STORAGE IS DISK without compression *
      *>                                                               *
      ...
      *>---------------------------------------------------------------*
       ...
       FILE-CONTROL.
           ...
           SELECT IDX-MAIN-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/STORAGE-DISK/idx-main.dat"
               ORGANIZATION IS INDEXED
               STORAGE IS DISK
           ...
           SELECT IDX-NUM-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/STORAGE-DISK/idx-numeric.dat"
               ORGANIZATION IS INDEXED
               STORAGE IS DISK
               ACCESS MODE IS DYNAMIC
           ...
           SELECT IDX-ALPHA-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/STORAGE-DISK/idx-alpha.dat"
               ORGANIZATION IS INDEXED
               STORAGE IS DISK
               ACCESS MODE IS DYNAMIC
           ...
           SELECT IDX-PERF-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/STORAGE-DISK/idx-perf-uuid-1m.dat"
               ORGANIZATION IS INDEXED
               STORAGE IS DISK
               ACCESS MODE IS DYNAMIC
       ...
       01  PERF-FIELDS.
           ...
           05 PERF-PATH                 PIC X(120)
              VALUE "tests/cobol/fileio/INDEXED/STORAGE-DISK/idx-perf-uuid-1m.dat".
       ...
       MAIN-PARA.
           ...
           DISPLAY "Storage variant: 1. STORAGE IS DISK without compression".
           DISPLAY "===================".
       ...
       TEST-INDEXED-MAIN-FILE.
           ...
           DISPLAY "File: tests/cobol/fileio/INDEXED/STORAGE-DISK/idx-main.dat".
       ...
       TEST-INDEXED-NUMERIC-FILE.
           ...
           DISPLAY "File: tests/cobol/fileio/INDEXED/STORAGE-DISK/idx-numeric.dat".
       ...
       TEST-INDEXED-ALPHA-FILE.
           ...
           DISPLAY "File: tests/cobol/fileio/INDEXED/STORAGE-DISK/idx-alpha.dat".
