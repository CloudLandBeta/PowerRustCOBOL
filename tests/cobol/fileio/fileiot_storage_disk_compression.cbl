      ...
      *>   - Storage variant: 2. STORAGE IS DISK WITH COMPRESSION    *
      *>                                                               *
      ...
      *>---------------------------------------------------------------*
       ...
       FILE-CONTROL.
           ...
           SELECT IDX-MAIN-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/STORAGE-DISK-COMPRESSION/idx-main.dat"
               ORGANIZATION IS INDEXED
           ...
           SELECT IDX-NUM-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/STORAGE-DISK-COMPRESSION/idx-numeric.dat"
               ORGANIZATION IS INDEXED
               STORAGE IS DISK WITH COMPRESSION
               ACCESS MODE IS DYNAMIC
           ...
           SELECT IDX-ALPHA-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/STORAGE-DISK-COMPRESSION/idx-alpha.dat"
               ORGANIZATION IS INDEXED
               STORAGE IS DISK WITH COMPRESSION
               ACCESS MODE IS DYNAMIC
           ...
           SELECT IDX-PERF-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/STORAGE-DISK-COMPRESSION/idx-perf-uuid-1m.dat"
               ORGANIZATION IS INDEXED
               STORAGE IS DISK WITH COMPRESSION
               ACCESS MODE IS DYNAMIC
       ...
       01  PERF-FIELDS.
           ...
           05 PERF-PATH                 PIC X(120)
              VALUE "tests/cobol/fileio/INDEXED/STORAGE-DISK-COMPRESSION/idx-perf-uuid-1m.dat".
       ...
       MAIN-PARA.
           ...
           DISPLAY "Storage variant: 2. STORAGE IS DISK WITH COMPRESSION".
           DISPLAY "===================".
       ...
       TEST-INDEXED-MAIN-FILE.
           ...
           DISPLAY "File: tests/cobol/fileio/INDEXED/STORAGE-DISK-COMPRESSION/idx-main.dat".
       ...
       TEST-INDEXED-NUMERIC-FILE.
           ...
           DISPLAY "File: tests/cobol/fileio/INDEXED/STORAGE-DISK-COMPRESSION/idx-numeric.dat".
       ...
       TEST-INDEXED-ALPHA-FILE.
           ...
           DISPLAY "File: tests/cobol/fileio/INDEXED/STORAGE-DISK-COMPRESSION/idx-alpha.dat".
