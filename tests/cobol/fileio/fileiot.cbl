      ...
      *>---------------------------------------------------------------*
       ...
       FILE-CONTROL.
           ...
           SELECT IDX-MAIN-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/idx-main.dat"
               ORGANIZATION IS INDEXED
           ...
           SELECT IDX-NUM-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/idx-numeric.dat"
               ORGANIZATION IS INDEXED
               ACCESS MODE IS DYNAMIC
           ...
           SELECT IDX-ALPHA-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/idx-alpha.dat"
               ORGANIZATION IS INDEXED
               ACCESS MODE IS DYNAMIC
           ...
           SELECT IDX-PERF-FILE
               ASSIGN TO "tests/cobol/fileio/INDEXED/idx-perf-uuid-1m.dat"
               ORGANIZATION IS INDEXED
               ACCESS MODE IS DYNAMIC
       ...
       01  PERF-FIELDS.
           ...
           05 PERF-PATH                 PIC X(80)
              VALUE "tests/cobol/fileio/INDEXED/idx-perf-uuid-1m.dat".
       ...
       TEST-INDEXED-MAIN-FILE.
           ...
           DISPLAY "File: tests/cobol/fileio/INDEXED/idx-main.dat".
       ...
       TEST-INDEXED-NUMERIC-FILE.
           ...
           DISPLAY "File: tests/cobol/fileio/INDEXED/idx-numeric.dat".
       ...
       TEST-INDEXED-ALPHA-FILE.
           ...
           DISPLAY "File: tests/cobol/fileio/INDEXED/idx-alpha.dat".
